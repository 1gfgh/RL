...
class MyQLAgent:
    def __init__(
        ...
        self.q_table = dict(lambda: np.zeros(self.n_actions))
...
if __name__ == "__main__":
    ...
    env = SumoEnvironment(
        net_file=os.path.join(cur_path, "sumo-rl/sumo_rl/nets/4x4-Lucas/4x4.net.xml"),
        route_file=os.path.join(cur_path, "sumo-rl/sumo_rl/nets/4x4-Lucas/4x4c1c2c1c2.rou.xml"),
        use_gui=False,
        num_seconds=1000,
        min_green=5,
        delta_time=5,
